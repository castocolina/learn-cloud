...
- **Component Scoped Styles:** Use `<style lang="scss">` for component-specific styling when needed
...
export async function load({ params }) {
  const lesson: LessonContent = await import(`../../../data/unit${params.unit}/${params.lesson}.json`);
  return {
