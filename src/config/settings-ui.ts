 ...
 * UI Configuration
 *
 * Centralized configuration for user interface components, theme, layout, and visual behavior.
 * This file contains settings for all UI-related functionality including components,
 * theme system, layout architecture, and responsive design.
 *
 ...
 * - Theme system (colors, palettes, validation)
 * - Layout architecture (sidebar, header, footer, breakpoints)
 * - Component configs (mermaid, codeBlock, iconGrid, dialog, flipCard)
 * - Navigation and breadcrumbs
 * - Content presentation
 * - Assessment UI defaults
 */
export const UI_SETTINGS: AppSettings["ui"] = {
	/**
