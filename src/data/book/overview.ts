			...
			content: [
				{
					...
					content: [
						{
							text: "Use the navigation menu on the left to browse through the units and topics. Your progress will be tracked automatically as you complete lessons and assessments."
						}
					]
				},
				{
					...
					content: [
						{
							text: "Each topic includes quizzes and study guides with flashcards to help you solidify your knowledge. The platform provides:"
						}
					]
				},
				{
