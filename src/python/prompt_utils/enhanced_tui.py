...
class EnhancedPromptExecutorTUI:
    ...
    async def run(self) -> int:
        """Run the enhanced TUI application with main menu loop."""
        self._print_header()
        ...
        while True:
            ...
            if not filtered_prompts:
                ...
                if not self._ask_return_to_menu():
                    return 0
                continue
            ...
            result = await self._execute_prompts()
    ...
    def _ask_return_to_menu(self) -> bool:
        """Ask user if they want to return to the main menu."""
        print("\n" + "=" * 50)
        while True:
            choice = input("Return to main menu? (y/n) [y]: ").strip().lower()
            if choice in ['', 'y', 'yes']:
                print("\n" + "=" * 70)
                return True
            elif choice in ['n', 'no']:
    ...
    async def _execute_prompts(self) -> int:
        ...
        async def progress_callback(prompt_name: str = "", unit: str = "", duration: float = 0, success: bool = True, agent_output: str = ""):
            ...
            display_real_time_progress(metrics, prompt_name, unit, agent_output)
        ...
        async def periodic_update():
            ...
            while True:
                ...
                if metrics:
                    display_real_time_progress(metrics, current_prompt_name, current_unit, current_agent_output)
        ...
        async def enhanced_progress_callback(prompt_name: str = "", unit: str = "", duration: float = 0, success: bool = True):
            ...
            await progress_callback(prompt_name, unit, duration, success, current_agent_output)
