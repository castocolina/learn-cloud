...
*   **Diagrams as Code:** Use **Mermaid.js** for all diagrams. **Crucial Rule:** All text descriptions for both **nodes** (e.g., `A["Node Text"]`) and **connectors/links** (e.g., `A --|"Link Text"|--> B`) **must always** be enclosed in double quotes, regardless of content. This is a mandatory rule to prevent rendering errors.
